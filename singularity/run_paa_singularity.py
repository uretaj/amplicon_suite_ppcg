...
parser.add_argument("-o", "--output_directory",
                    help="output directory names (will create if not already created)", required=True)
...
parser.add_argument("--scna_file", help="SCNA calls generated by Battenberg. Fields in the text file should"
                    " be in the Battenberg output format", required=True)
parser.add_argument("--data_repo", 
                    help="data repo directory", required=True)
#end of modification uretaj   
"""
...
if args.sif and not args.sif.endswith("ampliconsuite-pipeline_latest.sif"):
    ...
    args.sif+="ampliconsuite-pipeline_latest.sif"
...
sif =  os.path.realpath(args.data_repo)
if not sif.endswith("/"): sif+="/"
sif+="ampliconsuite-pipeline_latest.sif"
#sif = os.path.realpath(args.data_repo)+"/ampliconsuite-pipeline_latest.sif"
print("Path to singularity image "+sif)
...
path,bamname = os.path.split(args.sorted_bam)
sample_name = os.path.splitext(bamname)[0]
if args.scna_file:
    ...
    out_file = args.output_directory+"/seeds/"+sample_name + "_seeds.bed"
    _chr = -1
    cnvname = sample_name + "_seeds.bed"
...
env_outname = "paa_envs_" + sample_name + ".txt"
runscript_outname = "paa_singularity_" + sample_name + ".sh"
...
with open(runscript_outname, 'w') as outfile:
    ...
    sing_string = "singularity exec --no-home --cleanenv --env-file " + env_outname + " --bind $AA_DATA_REPO:" \
                  ...
                  "--bind " + cnvdir + ":/home/bed_dir --bind " + args.output_directory + ":/home/output --bind " \
                  "$HOME/mosek:/home/mosek/ " + sif + " bash /home/run_paa_script.sh "
